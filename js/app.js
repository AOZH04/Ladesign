(() => {
    ...
    function tabs() {
        ...
        if (Page) {
            let TabsBody = document.querySelectorAll(".grid");
            let arr = [];
            let classArr = [];
            for (let index = 0; index < TabsBody.length; index++) {
                arr.push(TabsBody[index].children);
                classArr.push(TabsBody[index]);
            }
            ...
            function createGrid(item1, item2) {
                ...
                if (1 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(1, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/2/3`;
                    }
                    if (windowWidth <= 320) item1[0].style.gridArea = `1/1/3/2`;
                }
                if (2 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/3`;
                        item1[1].style.gridArea = `1/3/3/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(1, ${rowsHeight})`;
                ...
                if (3 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/3`;
                        item1[1].style.gridArea = `1/3/2/5`;
                        item1[2].style.gridArea = `2/3/3/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (4 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[3].style.gridArea = `2/3/3/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                    ...
                    if (windowWidth <= 320) {
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[1].style.gridArea = `3/1/4/2`;
                        item1[3].style.gridArea = `5/1/6/2`;
                    }
                }
                if (5 == item1.length) {
                    if (windowWidth > 768) {
                ...
                if (6 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[1].style.gridArea = `1/2/3/3`;
                        item1[4].style.gridArea = `2/3/3/4`;
                        item1[5].style.gridArea = `2/4/3/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `4/1/5/3`;
                    }
                    if (windowWidth <= 320) {
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[1].style.gridArea = `3/1/4/2`;
                        item1[3].style.gridArea = `5/1/6/2`;
                        item1[5].style.gridArea = `7/1/8/2`;
                    }
                }
                if (7 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(3, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                    ...
                    if (windowWidth <= 768) {
                        ...
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `4/1/5/3`;
                        item1[6].style.gridArea = `5/1/7/3`;
                    }
                    if (windowWidth <= 320) {
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[1].style.gridArea = `3/1/4/2`;
                        item1[3].style.gridArea = `5/1/6/2`;
                        item1[5].style.gridArea = `7/1/8/2`;
                        item1[6].style.gridArea = `8/1/9/2`;
                    }
                }
                if (8 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(3, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `2/3/3/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[7].style.gridArea = `3/3/4/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (9 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(4, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `2/3/4/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                ...
                if (10 == item1.length) {
                    ...
                    if (windowWidth <= 768) {
                        ...
                        item1[5].style.gridArea = `4/1/5/3`;
                        item1[6].style.gridArea = `5/1/7/3`;
                        item1[9].style.gridArea = `8/1/9/3`;
                    }
                    if (windowWidth <= 320) {
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[1].style.gridArea = `3/1/4/2`;
                        ...
                        item1[5].style.gridArea = `7/1/8/2`;
                        item1[6].style.gridArea = `8/1/9/2`;
                        item1[9].style.gridArea = `11/1/12/2`;
                    }
                }
                if (11 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[5].style.gridArea = `2/3/4/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[9].style.gridArea = `4/3/5/4`;
                        item1[10].style.gridArea = `4/4/5/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (12 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(5, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `2/3/4/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[10].style.gridArea = `5/1/6/3`;
                        item1[11].style.gridArea = `5/3/6/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (13 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[10].style.gridArea = `5/1/6/2`;
                        item1[12].style.gridArea = `5/3/6/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (14 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(6, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `2/3/4/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[10].style.gridArea = `5/1/7/2`;
                        item1[11].style.gridArea = `5/2/7/3`;
                        item1[12].style.gridArea = `5/3/6/5`;
                        item1[13].style.gridArea = `6/3/7/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (15 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[10].style.gridArea = `5/1/7/2`;
                        item1[12].style.gridColumn = `3/5`;
                        item1[14].style.gridColumn = `3/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (16 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[10].style.gridArea = `5/1/7/2`;
                        item1[15].style.gridArea = `6/3/7/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (17 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(7, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `2/3/4/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[10].style.gridArea = `5/1/7/2`;
                        item1[15].style.gridArea = `6/3/8/5`;
                        item1[16].style.gridArea = `7/1/8/3`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (18 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[15].style.gridArea = `6/3/7/5`;
                        item1[16].style.gridArea = `7/1/8/3`;
                        item1[17].style.gridArea = `7/3/8/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (19 == item1.length) {
                    if (windowWidth > 768) {
                        ...
                        item1[9].style.gridArea = `4/3/5/5`;
                        item1[10].style.gridArea = `5/1/7/2`;
                        item1[15].style.gridArea = `6/3/7/4`;
                        item1[16].style.gridArea = `6/4/7/5`;
                        item1[17].style.gridArea = `7/1/8/3`;
                        item1[18].style.gridArea = `7/3/8/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                ...
                if (20 == item1.length) {
                    if (windowWidth > 768) {
                        item2.style.gridTemplateRows = `repeat(8, ${rowsHeight})`;
                        item1[0].style.gridArea = `1/1/3/2`;
                        item1[5].style.gridArea = `2/3/4/5`;
                        item1[6].style.gridArea = `3/1/4/3`;
                        item1[9].style.gridArea = `4/3/5/5`;
                        ...
                        item1[15].style.gridArea = `6/3/8/5`;
                        item1[16].style.gridArea = `7/1/8/3`;
                        item1[17].style.gridArea = `8/1/9/2`;
                        item1[18].style.gridArea = `8/2/9/3`;
                        item1[19].style.gridArea = `8/3/9/5`;
                    }
                    if (windowWidth <= 768) {
                        item2.style.gridTemplateColumns = `repeat(${qColumns}, 1fr)`;
                        item2.style.gridTemplateRows = `repeat(2, ${rowsHeight})`;
                        ...
                        if (oddLenght % 1 === 0 && oddLenght % 2 != 0) {
                            function oddNumbers(array) {
                                for (let i = 0; i < array.length; i++) {
                                    if (true) {
                                        Rows = array.indexOf(array[array.length - 1]) + 4;
                                        item2.style.gridTemplateRows = `repeat(${Rows}, ${rowsHeight})`;
                                    }
                                    break;
                                }
                            }
                            ...
                            Rows = newnumbers.indexOf(newnumbers[newnumbers.length - 1]) + 4;
                            item2.style.gridTemplateRows = `repeat(${Rows}, ${rowsHeight})`;
                        }
                    }
                    if (windowWidth <= 768) {
            ...
            for (let ind = 0; ind < arr.length; ind++) createGrid(arr[ind], classArr[ind]);
            let parentshowMorebtn = document.querySelectorAll(".tabs__body");
            let showMorebtn = document.querySelectorAll(".show__more");
            let korobNull = 1167;
            let korobNull1024 = 895;
            let korobNull768 = 660;
            let korobNull650 = 620;
            let korobNull600 = 570;
            let korobNull550 = 511;
            let korobNull500 = 461;
            let korobNull450 = 411;
            let korobNull400 = 361;
            let korobNull320 = 590;
            let fortr = document.querySelectorAll(".fortr");
            function forTrans() {
                fortr.forEach((element => {
                    if (!element.parentNode.classList.contains("active")) {
                        if (windowWidth > 1024) element.style.maxHeight = korobNull + "px";
                        if (windowWidth <= 1024) element.style.maxHeight = korobNull1024 + "px";
                        if (windowWidth <= 768) element.style.maxHeight = korobNull768 + "px";
                        if (windowWidth <= 650) element.style.maxHeight = korobNull650 + "px";
                        if (windowWidth <= 600) element.style.maxHeight = korobNull600 + "px";
                        if (windowWidth <= 550) element.style.maxHeight = korobNull550 + "px";
                        if (windowWidth <= 500) element.style.maxHeight = korobNull500 + "px";
                        if (windowWidth <= 450) element.style.maxHeight = korobNull450 + "px";
                        if (windowWidth <= 400) element.style.maxHeight = korobNull400 + "px";
                        if (windowWidth <= 320) element.style.maxHeight = korobNull320 + "px";
                    }
                }));
            }
            forTrans();
            showMorebtn.forEach((btn => {
                if (!btn.classList.contains("active")) btn.addEventListener("click", (() => {
                    parentshowMorebtn.forEach((korob => {
                        if (!korob.hasAttribute("hidden")) {
                            korob.classList.toggle("active");
                            btn.classList.toggle("active");
                            let gridenok = document.querySelectorAll(".grid");
                            gridenok.forEach((element => {
                                let valEl = element.offsetHeight;
                                element.setAttribute("heightBlock", valEl);
                            }));
                            fortr.forEach((element => {
                                let gr = element.querySelector(".grid");
                                let atrGr = gr.getAttribute("heightBlock");
                                element.style.maxHeight = atrGr + "px";
                            }));
                        }
                        if (korob.hasAttribute("hidden")) korob.classList.remove("active");
                    }));
                    forTrans();
                }));
            }));
            for (let index = 0; index < TabsBody.length; index++) if (TabsBody[index].children.length <= 11) {
                showMorebtn[index].style.display = "none";
                TabsBody[index].style.maxHeight = "none";
            }
        }
    }
    function menuInit() {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".others__slider")) new core(".others__slider", {
            modules: [ Navigation, Pagination, Scrollbar, Keyboard, Mousewheel, Autoplay, EffectFade, EffectFlip, EffectCube, EffectCoverflow, Grid ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
        ...
        let allSld = document.querySelectorAll(".swiper-slide img");
        allSld.forEach((element => {
            if (element.src.indexOf("?") > -1) element.parentNode.remove();
        }));
    }
    window.addEventListener("load", (function(e) {
        initSliders();
...
***************************************************************************** */
    ...
    let ContactsWrapper = document.querySelector(".contacts_wrapper");
    let DataScroll = document.querySelector("[data-scroll]");
    if (PriceWrapper) DataScroll.setAttribute("data-scroll", "0");
    if (ContactsWrapper) DataScroll.setAttribute("data-scroll", "0");
    document.addEventListener("DOMContentLoaded", (() => {
        function setScrollBy() {
            window.scroll(0, 1);
        }
        if (PriceWrapper) setScrollBy();
        if (ContactsWrapper) setScrollBy();
    }));
    if (PriceWrapper) {
        let btnRates = document.querySelectorAll(".rate_button");
        btnRates.forEach((Rate => {
            if (Rate) Rate.onclick = function() {
                let boxFormRate = document.querySelector(".form_rate");
                boxFormRate.innerHTML = `Тариф: <input disabled class="form_rate_input" type="text" value="` + Rate.id + `">`;
            };
        }));
    }
